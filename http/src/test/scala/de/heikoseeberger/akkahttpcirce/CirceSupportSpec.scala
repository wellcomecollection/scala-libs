 ...
 * It's copied from https://github.com/hseeberger/akka-http-json/blob/master/akka-http-circe/src/test/scala/de/heikoseeberger/akkahttpcirce/CirceSupportSpec.scala
  ...
  private def commonCirceSupport(support: BaseCirceSupport) = {
    ...
    "provide proper error messages for requirement errors" in {
      ...
      Unmarshal(entity)
        ...
        .failed
        .map(
          _ should have message "requirement failed: bar must start with 'bar'!")
    }
    ...
    "write None as null by default" in {
      ...
      Marshal(optionFoo)
        .to[RequestEntity]
        .map(_.asInstanceOf[HttpEntity.Strict].data
          .decodeString("UTF-8") shouldBe "{\"a\":null}")
    }
