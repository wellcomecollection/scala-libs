...
- [`listing`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/uk/ac/wellcome/storage/listing): Listing things from a provider e.g. listing keys in an S3 bucket.
...
- [`locking`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/uk/ac/wellcome/storage/locking): Distributed process locking.
...
- [`maxima`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/uk/ac/wellcome/storage/maxima): Find the maximum valued thing in a store.
...
- [`store`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/uk/ac/wellcome/storage/store): We start with a base trait for getting and putting to a storage provider. Then we can compose this to add more operations in a generic way.
...
- [`streaming`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/uk/ac/wellcome/storage/streaming): Convert Java/Scala classes to and from an `InputStream`.

- [`transfer`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/uk/ac/wellcome/storage/transfer): Transferring things within a storage provider, including transfer by prefix
