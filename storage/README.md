...
- [`listing`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/weco/storage/listing): Listing things from a provider e.g. listing keys in an S3 bucket.
...
- [`locking`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/weco/storage/locking): Distributed process locking.
...
- [`maxima`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/weco/storage/maxima): Find the maximum valued thing in a store.
...
- [`store`](https://github.com/wellcomecollection/scala-libs/tree/main/storage/src/main/scala/weco/storage/store): We start with a base trait for getting and putting to a storage provider. Then we can compose this to add more operations in a generic way.
