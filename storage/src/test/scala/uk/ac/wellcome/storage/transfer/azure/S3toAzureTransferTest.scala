...
class S3toAzureTransferTest extends TransferTestCases[
    ...
    Container,
    S3TypedStore[Record],
    AzureTypedStore[Record], Unit] with RecordGenerators with AzureFixtures with S3Fixtures {
  ...
  override def withTransfer[R](srcStore: S3TypedStore[Record], dstStore: AzureTypedStore[Record])(testWith: TestWith[Transfer[S3ObjectLocation, AzureBlobLocation], R]): R = {
