...
class S3toAzureTransferTest
    extends TransferTestCases[ObjectLocation, AzureBlobLocation, Record, Bucket, Container, S3TypedStore[Record], AzureTypedStore[Record], Unit]
  ...
  override def withTransfer[R](srcStore: S3TypedStore[Record], dstStore: AzureTypedStore[Record])(testWith: TestWith[Transfer[ObjectLocation, AzureBlobLocation], R]): R = {
