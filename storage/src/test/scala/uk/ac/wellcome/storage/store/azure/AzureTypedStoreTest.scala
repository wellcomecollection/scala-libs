...
class AzureTypedStoreTest
  ...
  override def withTypedStore[R](
    ...
    testWith: TestWith[AzureTypedStore[Record], R])(implicit codec: Codec[Record]): R = {
  ...
  override def withStreamStoreImpl[R](
    context: Unit,
    initialEntries: Map[AzureBlobLocation, InputStreamWithLength])(testWith: TestWith[AzureStreamStore, R]): R = {
